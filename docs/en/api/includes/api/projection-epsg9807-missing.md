...
Returns the sphere circumference; EPSG:9807 is not spherical, so it returns undefined.
...
Returns the sphere extent; EPSG:9807 is not spherical, so it returns undefined.
