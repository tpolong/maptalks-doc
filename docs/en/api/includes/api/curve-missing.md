...
Returns an outline polygon of the geometry extent, null without a painter
...
Set new coordinates to the curve; fires shapechange
...
Whether the geometry has holes; optional member not implemented by line shapes
...
Returns the geometry 2D pixel extent at current zoom, null if not on a map
...
Callback after shape changes; clears cache, repaints and fires shapechange
...
Callback after symbol changes; refreshes painter symbol and fires symbolchange
...
Set the altitude of the geometry, syncing coordinates z and properties, then repaint
...
Returns hole rings of the geometry; optional member not implemented by line shapes
...
Returns shell ring coordinates of the geometry; optional member not implemented by line shapes
...
Returns child geometries of the collection; optional member implemented only by collections
...
Optional lifecycle callback when removed from a layer; not implemented by Curve
...
Optional lifecycle callback when added to a layer; not implemented by Curve
