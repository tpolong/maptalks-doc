...
Sector has no holes and always returns an empty array
...
Sector has no animation; it calls show to display it directly
...
Sector never has holes and always returns false
