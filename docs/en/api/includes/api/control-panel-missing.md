...
Lifecycle callback invoked after the control is added to the map, empty by default and overridable.
...
Lifecycle callback invoked when the control is removed from the map, empty by default.
