...
Returns the sphere circumference, the size of the sphere extent, cached after the first call.
...
Returns the sphere extent computed from the projected lnglat limits, cached after the first call.
