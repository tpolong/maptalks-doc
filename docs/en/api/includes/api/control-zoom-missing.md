...
Optional callback after the control is added to a map, implemented by subclasses
...
Recalculate and update the control position when position is in the changed options
