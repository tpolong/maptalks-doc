...
获取集合中各子 geometry 的 coordinates
...
按新的 coordinate 重建集合内的全部子 geometry
...
获取 symbol，自身未设置时返回子 geometry 的 children 数组
...
结束对集合的编辑，并恢复编辑前的 symbol 与 draggable
...
获取几何图形的 altitude，未设置时取 coordinate 的 z 或 0
...
获取几何图形所有 coordinate 中最大的 altitude
