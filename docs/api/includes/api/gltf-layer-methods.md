<details><summary>setURLModifier(urlModifier)</summary>
<div>
<br/>

设置模型资源 URL 的改写函数，用于替换模型的加载地址
...
按地理 coordinate 拾取 marker，返回拾取结果数组
...
按容器坐标拾取 marker，可用 excludeMasks 与 filter 过滤
