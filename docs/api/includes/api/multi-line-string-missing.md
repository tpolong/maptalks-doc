...
用新 coordinates 重建集合内的子 geometry
...
设置 symbol，children 数组按序分发给各子 geometry
...
位置变化回调，清理缓存并重绘，触发 positionchange
...
symbol 变化回调，刷新 painter 并触发 symbolchange
...
设置几何图形的 altitude，并同步改写 coordinate 的 z 值
...
获取几何体外环的 coordinate 数组，线串不实现该方法
