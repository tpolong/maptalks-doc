...
获取文本框的方框轮廓 marker，尺寸取自 containerExtent
...
获取当前 zoom 下文本框的 2D 像素 extent，不在 map 上时为 null
...
symbol 变化时刷新 symbol、重建尺寸缓存并触发事件
...
获取文本框的海拔高度，优先取 altitude 属性，否则取坐标 z，都没有则 0
...
获取文本框所有 coordinate 中最小的 altitude
...
获取文本框所有 coordinate 中最大的 altitude
...
获取几何体的孔洞 coordinate 数组，仅面状几何子类实现
...
获取几何体外环的 coordinate 数组，仅面状几何子类实现
...
获取几何体按中心旋转时的固定角度偏移，目前仅 Sector 实现
